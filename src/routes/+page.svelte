...
<aside id="ftco-hero" class="js-fullheight">
	<div class="flexslider js-fullheight">
		<ul class="slides">
		   <li style="background-image: url(/hero_1.jpg);">
		   ...
		   <li style="background-image: url(/hero_3.jpg);">
			   <div class="overlay-gradient"></div>
			   <div class="container">
				   <div class="row">
					   <div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text animated fadeInUp">
		   ...
		   <li style="background-image: url(/hero_2.jpg);">
			   <div class="overlay-gradient"></div>
			   <div class="container">
				   <div class="row">
					   <div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text animated fadeInUp">
...
<div id="ftco-counter" class="ftco-counters" style="background-image: url(/img_bg_3.jpg);" data-stellar-background-ratio="0.5">
		...
		<div class="row">
			<div class="col-md-6 col-lg-4">
				<div class="blog-featured animate-box">
					<a href=""><img class="img-responsive img-rounded" src="/blog-1.jpg" alt=""></a>
					<h2><a href="">Far from the countries Vokalia and Consonantia</a></h2>
			...
			<div class="col-md-6 col-lg-4">
				<div class="blog-featured animate-box">
					<a href=""><img class="img-responsive img-rounded" src="/blog-2.jpg" alt=""></a>
					<h2><a href="">Far from the countries Vokalia and Consonantia</a></h2>
					<p class="meta"><span>Jan 5, 2017</span> | <span>3 Comments</span></p>
					<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however</p>
				</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="blog-featured animate-box">
					<a href=""><img class="img-responsive img-rounded" src="/blog-3.jpg" alt=""></a>
					<h2><a href="">Far from the countries Vokalia and Consonantia</a></h2>
					<p class="meta"><span>Jan 5, 2017</span> | <span>3 Comments</span></p>
					<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however</p>
				</div>
